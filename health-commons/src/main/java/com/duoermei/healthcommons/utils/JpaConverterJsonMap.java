...
@Slf4j
public class JpaConverterJsonMap implements AttributeConverter<Map<String, Object>, String> {
    ...
    public Map<String, Object> convertToEntityAttribute(String column) {
        ...
        try {
            return objectMapper.readValue(column, new TypeReference<Map<String, Object>>() {
            });
        } catch (IOException e) {
