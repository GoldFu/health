...
public class JwtAuthenticationFilter extends BasicAuthenticationFilter {
    ...
    public JwtAuthenticationFilter(AuthenticationManager authManager, ObjectMapper objectMapper, UserDetailsService userDetailsService, StringRedisTemplate stringRedisTemplate) {
        super(authManager);
    ...
    protected void doFilterInternal(HttpServletRequest req,
            ...
            if (!Constants.TOURIST_UUID.equals(username)) {
                ...
                if (!authToken.equals(curryToken)) {
                    //TokenRequest.onAuthenticationFailure(res);//声明静态统一方法di
//                    res.setCharacterEncoding("utf-8");
//                    res.setContentType("application/json");
//                    res.getWriter().append(objectMapper.writeValueAsString(new JSONObject().fluentPut("msg", "token已过期").fluentPut("code", "401")));
//
                   // ResponseStatus.response(res,"token已过期");
                    return;
                }
            }
